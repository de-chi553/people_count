"""
Django settings for people_count project.
...
SECRET_KEY = 'django-insecure-(&xgk(!#%$6!kovwwsb+c@nmab4-texn5ui75iyhj+a(_z^fg@'
...
ROOT_URLCONF = 'people_count.urls'
...
WSGI_APPLICATION = 'people_count.wsgi.application'
